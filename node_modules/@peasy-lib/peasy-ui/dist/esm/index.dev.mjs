class UIView {
    ...
    updateToUI() {
        const updateSelfFirst = this.state === 'created';
        if (!updateSelfFirst) {
        ...
        switch (this.state) {
            case 'created':
                ...
                this.render = !(this.element.hasAttribute?.('PUI-UNRENDERED') ?? false);
                if (this.render) {
                    const parentView = this.parent?.parent;
                    ...
                    const parentElement = this.parentElement ?? UI.parentElement(this.element, this.parent);
        ...
        switch (this.moved) {
            ...
            case 'move':
                if (this.getAnimations().length === 0) {
                    const parent = (this.parentElement ?? UI.parentElement(this.element, this.parent));
...
class UIBinding {
    ...
    static create(options) {
        ...
        if (binding.object.$parent == null) {
            const parentModel = binding.parent.parent?.object?.$parent;
            if (parentModel != null) {
                ...
                if (typeof this.attribute === 'boolean') {
                    ...
                    for (let i = same, ii = uiValue.length, j = same; i < ii; i++, j++) {
                        ...
                        if (view == null) {
                            ...
                            const view = UIView.create(this.element.parentElement, model, this.template.cloneNode(true), { parent: this, prepare: false, sibling: lastDoneUI ?? this.element });
                            views.push(view);
                            lastDoneUI = view;
                            continue;
                        }
...
class _UI {
    ...
    static replaceWithComment(element, view, parent, attr, template) {

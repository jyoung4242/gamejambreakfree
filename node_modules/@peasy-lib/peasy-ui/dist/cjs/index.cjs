...
class UIView {
    ...
    get lastElement() {
        if (this.render == null) this.render = !(this.element.hasAttribute?.("PUI-UNRENDERED") ?? false);
        if (this.render) return this.element;
        const t = this.bindings.flatMap((t => t.views));
        const e = t.slice(-1)[0];
        ...
        switch (this.state) {
          case "created":
            ...
            if (this.render) {
                ...
                const e = t?.render ?? false;
                let i = (!e ? t?.sibling : this.sibling) ?? null;
                i = (i instanceof UIView ? i.lastElement : i) ?? null;
                const n = this.parentElement ?? s.parentElement(this.element, this.parent);
                n.insertBefore(this.element, i?.nextSibling ?? null);
            }
            this.attachResolve();
        ...
        switch (this.moved) {
          ...
          case "move":
            if (this.getAnimations().length === 0) {
                const t = this.parentElement ?? s.parentElement(this.element, this.parent);
                let e = (this.sibling instanceof UIView ? this.sibling.lastElement : this.sibling) ?? null;
                if (this.render) t.insertBefore(this.element, e?.nextSibling ?? null); else {
                    const i = this.bindings.flatMap((t => t.views));
                    for (const s of i) {
                        t.insertBefore(s.element, e?.nextSibling ?? null);
                        e = s.element;
                    }
                }
...
class UIBinding {
    ...
    static create(t) {
        ...
        if (e.object.$parent == null) {
            const t = e.parent.parent?.object?.$parent;
            if (t != null) e.object.$parent = t;
        }
        e.property = n;
        e.arguments = i;
    ...
    updateToUI() {
        ...
        if (this.template != null) if (this.template instanceof HTMLElement) if (typeof this.attribute === "boolean") {
            ...
            if (t.length !== h.length) e = true; else for (let r = 0, l = t.length; r < l; r++) {
                let l, o;
                if (n == null) {
                    if (t[r] !== h[r]) {
                        e = true;
                    ...
                    l = s.resolveValue(t[r] ?? {}, n);
                    o = s.resolveValue(h[r] ?? {}, n);
                    if (l !== o) e = true;
                    if (t[r] !== h[r]) i = true;
                }
            }
            ...
            for (let t = 0, e = r.length, i = 0; t < e; t++, i++) {
                ...
                if (n == null) {
                    ...
                    h = s.resolveValue(l[i] ?? {}, n);
                }
                if (e === h) o++; else break;
            }
            if (o === r.length && r.length === l.length) return this.updateViews(t, r);
            const u = this.views.splice(0, o);
            let a = u[u.length - 1];
            for (let t = o, e = r.length, i = o; t < e; t++, i++) {
                const e = r[t];
                ...
                const l = i?.model.$model[this.attribute];
                const o = n == null ? l : s.resolveValue(l ?? {}, n);
                if (h === o) {
                    u.push(i);
                    i.move(a ?? this.element);
                    a = i;
                    continue;
                }
                if (!r.slice(t).map((t => n == null ? t : s.resolveValue(t ?? {}, n))).includes(o)) {
                    i.destroy();
                    t--;
                    a = i;
                    continue;
...
class _UI {
        ...
        if (t.nodeType === 3) {
            ...
            h.push(...Object.keys(t.attributes ?? []).reverse().map((h => {
                ...
                if (l.name.startsWith("pui.")) {
                    const s = l.value.match(this.regexAttribute);
                    let [h, r, o, u, a] = s;
                    let c;
                    let f;
                    let p = false;
                    if (o !== "@") {
                        ...
                        if (s != null) {
                            ...
                            ({element: t, template: f} = this.replaceWithComment(t, i, n, l.name));
                            r = o === "=";
                            o = true;
                            if (u === "|") p = true;
                        } else if (u === "=" && o === "=") {
                            if (!t.tagName.includes("-")) {
                                ...
                                if (e.nodeType !== 8) ({element: t, template: f} = this.replaceWithComment(t, i, n, l.name, f)); else t = e;
                            }
                            f = r;
                            o = true;
                        } else if (u === "*") ({element: t, template: f} = this.replaceWithComment(t, i, n, l.name)); else if (u === "|") p = true; else if (r !== "checked") t.setAttribute(r, t.getAttribute?.(r) ?? "");
                    }
                    return [ this.bind({
                        selector: t,
                        attribute: r,
                ...
                while (a != null) {
                    ...
                    r.push(this.bind({
                        ...
                        toUI(e, i, n, h, r) {
                            ...
                            const u = o.map(((t, i) => {
                                if (i % 2 === 0) return t;
                                const l = t.match(s.regexSplitConditionalValue);
                                if (l) {
                                    const i = t === `${n}${r}` ? e : s.resolveValue(h, l[1]);
                                    const o = l[2] === "=";
                                    return !!i === o ? l[3].slice(1, -1) : "";
                                }
                                return t === n ? e : s.resolveValue(h, t);
                            })).join("");
                            t.setAttribute(l.name, u);
                            return u;
                        },
                        parent: i,
                        value: m
    ...
    static replaceWithComment(t, e, i, s, n) {
        const h = document.createComment(s);
        this.parentNode(t, i).insertBefore(h, t);
        this.parentNode(t, i).removeChild(t);
        t.removeAttribute(s);
        n = n ?? t;
        t = h;
        if (t.parentNode instanceof DocumentFragment) e.element = t;
        return {
            element: t,
            template: n
        };
    ...
    static parseAttribute(t, e, i, s, n, h) {
        ...
        if (u !== "@") {
            ...
            if (h != null) {
                ...
                o = t.nodeName.toLowerCase() === "option" ? "selected" : "checked";
                a = t => t ? f : void 0;
                u = t => t === f;
            } else if (o === "") if (a === ">") {
                ...
                ({element: t, template: p} = this.replaceWithComment(t, i, s, n));
                o = u === "=";
                u = true;
                if (a === "|") m = true;
            } else if (a === "=" && u === "=") {
                const e = this.parentNode(t, s);
                if (e.nodeType !== 8) ({element: t, template: p} = this.replaceWithComment(t, i, s, n, p)); else t = e;
                p = o;
                m = true;
                u = true;
            } else if (a === "*") ({element: t, template: p} = this.replaceWithComment(t, i, s, n)); else if (a === "|") m = true; else if (o !== "checked") t.setAttribute(o, "");
        }
        return [ this.bind({
            selector: t,
            attribute: o,

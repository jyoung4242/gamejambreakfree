...
exports.DiscoveryV1Api = void 0;
const runtime = require("../runtime");
const models_1 = require("../models");
/**
 *
 */
class DiscoveryV1Api extends runtime.BaseAPI {
    /**
    ...
    getPingServiceEndpointsRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(models_1.DiscoveryResponseInnerFromJSON));
        });
    }
    /**
     * Returns an array of all regions with a host and port that a client can directly ping.

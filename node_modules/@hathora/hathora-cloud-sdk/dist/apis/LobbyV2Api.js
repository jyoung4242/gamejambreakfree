...
exports.LobbyV2Api = void 0;
const runtime = require("../runtime");
const models_1 = require("../models");
/**
 *
 */
class LobbyV2Api extends runtime.BaseAPI {
    /**
    ...
    createLobbyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.CreateLobbyRequestToJSON)(requestParameters.createLobbyRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.LobbyFromJSON)(jsonValue));
        });
    }
    /**
     * Create a new [lobby](https://hathora.dev/docs/concepts/hathora-entities#lobby) for an existing [application](https://hathora.dev/docs/concepts/hathora-entities#application) using `appId`.
    ...
    createLocalLobbyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.CreatePrivateLobbyRequestToJSON)(requestParameters.createPrivateLobbyRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.LobbyFromJSON)(jsonValue));
        });
    }
    ...
    setLobbyStateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.SetLobbyStateRequestToJSON)(requestParameters.setLobbyStateRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.LobbyFromJSON)(jsonValue));
        });
    }

...
exports.ManagementV1Api = void 0;
const runtime = require("../runtime");
const models_1 = require("../models");
/**
 *
 */
class ManagementV1Api extends runtime.BaseAPI {
    /**
     */
    sendVerificationEmailRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.VerificationEmailRequestToJSON)(requestParameters.verificationEmailRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.VerificationEmailResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    sendVerificationEmail(verificationEmailRequest, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.sendVerificationEmailRaw({ verificationEmailRequest: verificationEmailRequest }, initOverrides);
            return yield response.value();
        });
    }
}
exports.ManagementV1Api = ManagementV1Api;

...
import { CustomerPortalUrlToJSON, InvoiceFromJSON, PartialCardCardPaymentMethodAchAchPaymentMethodLinkLinkPaymentMethodFromJSON, } from '../models';
/**
 *
 */
export class BillingV1Api extends runtime.BaseAPI {
    /**
     */
    ...
    initStripeCustomerPortalUrl(customerPortalUrl, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.initStripeCustomerPortalUrlRaw({ customerPortalUrl: customerPortalUrl }, initOverrides);
            return yield response.value();
        });
    }
}
